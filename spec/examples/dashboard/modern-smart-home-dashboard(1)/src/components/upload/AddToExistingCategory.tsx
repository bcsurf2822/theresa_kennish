...
export function AddToExistingCategory() {
  ...
  const handleSubmit = () => {
    console.log("Adding to category:", { selectedCategory, images })
  }

  return (
    <div className="bg-card border border-border rounded-xl p-6 space-y-6">
      <div className="space-y-2">
        <Label htmlFor="select-category" className="text-muted-foreground">
          Select Category
        </Label>
