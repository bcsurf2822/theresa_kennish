...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/mux-embed@5.15.0/node_modules/mux-embed/dist/mux.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var ra = Object.getPrototypeOf, aa = Object.prototype.hasOwnProperty;
var ft = function(r, e) {
    return function() {
        return r && (e = r(r = 0)), e;
    };
...
var ia = function(r, e, t, i) {
    if (e && typeof e == "object" || typeof e == "function") for(var a = ta(e), n = 0, o = a.length, s; n < o; n++)s = a[n], !aa.call(r, s) && s !== t && _t(r, s, {
        get: (function(u) {
            return e[u];
        }).bind(null, s),
        enumerable: !(i = ea(e, s)) || i.enumerable
    });
    return r;
};
var G = function(r, e, t) {
    return t = r != null ? Zr(ra(r)) : {}, ia(e || !r || !r.__esModule ? _t(t, "default", {
        value: r,
        enumerable: !0
    }) : t, r);
};
var Q = B(function(Xi, ht) {
    var xe;
...
var Tr = B(function(Cs, wr) {
    ...
    function Ba(r) {
        var e = [], t = r.tagName;
        return r.namespaceURI === "http://www.w3.org/1999/xhtml" && (t = t.toLowerCase()), e.push("<" + t + ja(r) + Va(r)), Ha.indexOf(t) > -1 ? e.push(" />") : (e.push(">"), r.childNodes.length ? e.push.apply(e, r.childNodes.map(gr)) : r.textContent || r.innerText ? e.push(et(r.textContent || r.innerText)) : r.innerHTML && e.push(r.innerHTML), e.push("</" + t + ">")), e.join("");
    }
    function Ua(r, e) {
        var t = Ne(r[e]);
    ...
    function br(r) {
        ...
        return r.forEach(function(t) {
            ...
            i === "style" && (a = Fa(a)), e.push(i + '="' + Wa(a) + '"');
        }), e.length ? " " + e.join(" ") : "";
    }
    function ja(r) {
        var e = [];
        for(var t in r)Ua(r, t) && e.push({
            name: t,
            value: r[t]
        });
...
var rt = B(function(Hs, kr) {
    te();
    var tt = Ye(), Ga = Xe(), Ja = $e(), Qa = Ze(), za = Tr(), Er = "http://www.w3.org/1999/xhtml";
    kr.exports = L;
    function L(r, e, t) {
    ...
    L.prototype.removeEventListener = Qa;
    L.prototype.addEventListener = Ja;
    L.prototype.dispatchEvent = Ga;
...
var Ar = B(function(js, Rr) {
    te();
    var Ka = Ye(), Ya = fr(), Xa = mr(), qe = rt(), $a = Dr(), Za = qr(), ei = Xe(), ti = $e(), ri = Ze();
    Rr.exports = Ue;
    function Ue() {
    ...
    j.getElementById = function(e) {
        e = String(e);
        var t = Ka(this.childNodes, function(i) {
            if (String(i.id) === e) return i;
        });
        return t || null;
    };
    j.getElementsByClassName = qe.prototype.getElementsByClassName;
    j.getElementsByTagName = qe.prototype.getElementsByTagName;
    j.contains = qe.prototype.contains;
    j.removeEventListener = ri;
    j.addEventListener = ti;
    j.dispatchEvent = ei;
});
...
var nt = B(function(Gs, Ir) {
    var Lr = ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable", ii = Or(), Re;
    typeof document != "undefined" ? Re = document : (Re = Lr["__GLOBAL_DOCUMENT_CACHE@4"], Re || (Re = Lr["__GLOBAL_DOCUMENT_CACHE@4"] = ii));
    Ir.exports = Re;
});
function pt(r) {
...
var Y = {
    ...
    var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3, t, i, a, n, o, s = r ? [
        ...
        console
    ], u = (t = console.trace).bind.apply(t, V(s)), f = (i = console.info).bind.apply(i, V(s)), g = (a = console.debug).bind.apply(a, V(s)), k = (n = console.warn).bind.apply(n, V(s)), h = (o = console.error).bind.apply(o, V(s)), c = e;
    return {
        trace: function() {
        ...
        debug: function() {
            for(var w = arguments.length, x = new Array(w), v = 0; v < w; v++)x[v] = arguments[v];
            if (!(c > Y.DEBUG)) return g.apply(void 0, V(x));
        },
        info: function() {
            for(var w = arguments.length, x = new Array(w), v = 0; v < w; v++)x[v] = arguments[v];
        ...
        warn: function() {
            for(var w = arguments.length, x = new Array(w), v = 0; v < w; v++)x[v] = arguments[v];
            if (!(c > Y.WARN)) return k.apply(void 0, V(x));
        },
        error: function() {
            for(var w = arguments.length, x = new Array(w), v = 0; v < w; v++)x[v] = arguments[v];
            if (!(c > Y.ERROR)) return h.apply(void 0, V(x));
        },
        get level () {
            return c;
        },
...
function N(r, e, t) {
    return e && Et(r.prototype, e), t && Et(r, t), r;
}
function d(r, e, t) {
...
function fe(r, e) {
    return e = e != null ? e : {}, Object.getOwnPropertyDescriptors ? Object.defineProperties(r, Object.getOwnPropertyDescriptors(e)) : sa(Object(e)).forEach(function(t) {
...
var He = function(r) {
    ...
    var u = function(v, m) {
        ...
        var _ = m.levels, l = m.audioTracks, y = m.url, T = m.stats, E = m.networkDetails, S = m.sessionData, I = {}, M = {};
        ...
        var O = He(T), q = O.bytesLoaded, Z = O.requestStart, we = O.responseStart, Te = O.responseEnd;
        u("requestcompleted", fe(ue({}, Me(S)), {
    ...
    var g = function(v, m) {
        var _ = m.details, l = m.level, y = m.networkDetails, T = m.stats, E = He(T), S = E.bytesLoaded, I = E.requestStart, M = E.responseStart, O = E.responseEnd, q = _.fragments[_.fragments.length - 1], Z = s(q) + o(q.duration);
        u("requestcompleted", {
            request_event_type: v,
            ...
            request_current_level: l,
            request_type: "manifest",
            request_hostname: F(_.url),
            request_response_headers: Se(y),
    ...
    var k = function(v, m) {
        var _ = m.details, l = m.networkDetails, y = m.stats, T = He(y), E = T.bytesLoaded, S = T.requestStart, I = T.responseStart, M = T.responseEnd;
        u("requestcompleted", {
            request_event_type: v,
            ...
            request_type: "manifest",
            request_hostname: F(_.url),
            request_response_headers: Se(l)
        });
    };
    t.on(a.Events.AUDIO_TRACK_LOADED, k);
    var h = function(v, m) {
        var _ = m.stats, l = m.networkDetails, y = m.frag;
        _ = _ || y.stats;
        var T = He(_), E = T.bytesLoaded, S = T.requestStart, I = T.responseStart, M = T.responseEnd, O = l ? Se(l) : void 0, q = {
            request_event_type: v,
            request_bytes_loaded: E,
            request_start: S,
            request_response_start: I,
            request_response_end: M,
            request_hostname: l ? F(l.responseURL) : void 0,
            request_id: O ? de(O) : void 0,
            request_response_headers: O,
            request_media_duration: y.duration,
            request_url: l == null ? void 0 : l.responseURL
        };
        y.type === "main" ? (q.request_type = "media", q.request_current_level = y.level, q.request_video_width = (t.levels[y.level] || {}).width, q.request_video_height = (t.levels[y.level] || {}).height, q.request_labeled_bitrate = (t.levels[y.level] || {}).bitrate) : q.request_type = y.type, u("requestcompleted", q);
    };
    t.on(a.Events.FRAG_LOADED, h);
    var c = function(v, m) {
        var _ = m.frag, l = _.start, y = s(_), T = {
            currentFragmentPDT: y,
            currentFragmentStart: o(l)
        };
        u("fragmentchange", T);
    };
    t.on(a.Events.FRAG_CHANGED, c);
    var p1 = function(v, m) {
        var _ = m.type, l = m.details, y = m.response, T = m.fatal, E = m.frag, S = m.networkDetails, I = (E == null ? void 0 : E.url) || m.url || "", M = S ? Se(S) : void 0;
        if ((l === a.ErrorDetails.MANIFEST_LOAD_ERROR || l === a.ErrorDetails.MANIFEST_LOAD_TIMEOUT || l === a.ErrorDetails.FRAG_LOAD_ERROR || l === a.ErrorDetails.FRAG_LOAD_TIMEOUT || l === a.ErrorDetails.LEVEL_LOAD_ERROR || l === a.ErrorDetails.LEVEL_LOAD_TIMEOUT || l === a.ErrorDetails.AUDIO_TRACK_LOAD_ERROR || l === a.ErrorDetails.AUDIO_TRACK_LOAD_TIMEOUT || l === a.ErrorDetails.SUBTITLE_LOAD_ERROR || l === a.ErrorDetails.SUBTITLE_LOAD_TIMEOUT || l === a.ErrorDetails.KEY_LOAD_ERROR || l === a.ErrorDetails.KEY_LOAD_TIMEOUT) && u("requestfailed", {
            request_error: l,
            request_url: I,
            request_hostname: F(I),
            request_id: M ? de(M) : void 0,
            request_type: l === a.ErrorDetails.FRAG_LOAD_ERROR || l === a.ErrorDetails.FRAG_LOAD_TIMEOUT ? "media" : l === a.ErrorDetails.AUDIO_TRACK_LOAD_ERROR || l === a.ErrorDetails.AUDIO_TRACK_LOAD_TIMEOUT ? "audio" : l === a.ErrorDetails.SUBTITLE_LOAD_ERROR || l === a.ErrorDetails.SUBTITLE_LOAD_TIMEOUT ? "subtitle" : l === a.ErrorDetails.KEY_LOAD_ERROR || l === a.ErrorDetails.KEY_LOAD_TIMEOUT ? "encryption" : "manifest",
            request_error_code: y == null ? void 0 : y.code,
            request_error_text: y == null ? void 0 : y.text
        }), T) {
            var O, q = "".concat(I ? "url: ".concat(I, "\n") : "") + "".concat(y && (y.code || y.text) ? "response: ".concat(y.code, ", ").concat(y.text, "\n") : "") + "".concat(m.reason ? "failure reason: ".concat(m.reason, "\n") : "") + "".concat(m.level ? "level: ".concat(m.level, "\n") : "") + "".concat(m.parent ? "parent stream controller: ".concat(m.parent, "\n") : "") + "".concat(m.buffer ? "buffer length: ".concat(m.buffer, "\n") : "") + "".concat(m.error ? "error: ".concat(m.error, "\n") : "") + "".concat(m.event ? "event: ".concat(m.event, "\n") : "") + "".concat(m.err ? "error message: ".concat((O = m.err) === null || O === void 0 ? void 0 : O.message, "\n") : "");
            u("error", {
                player_error_code: _,
                player_error_message: l,
                player_error_context: q
            });
        }
    };
    t.on(a.Events.ERROR, p1);
    var w = function(v, m) {
        var _ = m.frag, l = _ && _._url || "";
        u("requestcanceled", {
            request_event_type: v,
            request_url: l,
            request_type: "media",
    ...
    var x = function(v, m) {
        var _ = m.level, l = t.levels[_];
        if (l && l.attrs && l.attrs.BANDWIDTH) {
            var y = l.attrs.BANDWIDTH, T, E = parseFloat(l.attrs["FRAME-RATE"]);
            isNaN(E) || (T = E), y ? u("renditionchange", {
                video_source_fps: T,
                video_source_bitrate: y,
                video_source_width: l.width,
                video_source_height: l.height,
                video_source_rendition_name: l.name,
                video_source_codec: l == null ? void 0 : l.videoCodec
            }) : n.warn("missing BANDWIDTH from HLS manifest parsed by HLS.js");
        }
    };
    t.on(a.Events.LEVEL_SWITCHED, x), t._stopMuxMonitor = function() {
        t.off(a.Events.MANIFEST_LOADED, f), t.off(a.Events.LEVEL_LOADED, g), t.off(a.Events.AUDIO_TRACK_LOADED, k), t.off(a.Events.FRAG_LOADED, h), t.off(a.Events.FRAG_CHANGED, c), t.off(a.Events.ERROR, p1), t.off(a.Events.FRAG_LOAD_EMERGENCY_ABORTED, w), t.off(a.Events.LEVEL_SWITCHED, x), t.off(a.Events.DESTROYING, t._stopMuxMonitor), delete t._stopMuxMonitor;
...
var It = function(r, e) {
    ...
    var t = F(r.url), i = r.url, a = r.bytesLoaded, n = new Date(r.requestStartDate).getTime(), o = new Date(r.firstByteDate).getTime(), s = new Date(r.requestEndDate).getTime(), u = isNaN(r.duration) ? 0 : r.duration, f = typeof e.getMetricsFor == "function" ? e.getMetricsFor(r.mediaType).HttpList : e.getDashMetrics().getHttpRequests(r.mediaType), g;
    ...
    var n = fa(t), o = function(_, l) {
        return r.emit(e, _, l);
    }, s = function(_) {
        var l = _.type, y = _.data, T = (y || {}).url;
        o("requestcompleted", {
            request_event_type: l,
            request_start: 0,
    ...
    var u = {}, f = function(_) {
        ...
        return l.length === 0 ? null : l[l.length - 1];
    }, g = function(_) {
        var l = _.type, y = _.fragmentModel, T = _.chunk, E = f(y);
        k({
            type: l,
            request: E,
            chunk: T
        ...
        var l = _.type, y = _.chunk, T = _.request, E = (y || {}).mediaInfo, S = E || {}, I = S.type, M = S.bitrateList;
        M = M || [];
        var O = {};
        M.forEach(function(Ee, z) {
            O[z] = {}, O[z].width = Ee.width, O[z].height = Ee.height, O[z].bitrate = Ee.bandwidth, O[z].attrs = {};
        }), I === "video" ? u.video = O : I === "audio" ? u.audio = O : u.media = O;
        var q = It(T, t), Z = q.requestStart, we = q.requestResponseStart, Te = q.requestResponseEnd, W = q.requestResponseHeaders, oe = q.requestMediaDuration, je = q.requestHostname, We = q.requestUrl, Ge = q.requestId;
        o("requestcompleted", {
            request_event_type: l,
            request_start: Z,
            request_response_start: we,
    ...
    var p1 = {
        ...
        if (p1.video && typeof p1.video.bitrate == "number") {
            ...
            if (p1.audio && typeof p1.audio.bitrate == "number" && (_ += p1.audio.bitrate), _ !== p1.totalBitrate) return p1.totalBitrate = _, {
                ...
                video_source_codec: _a(p1.video.codec)
            };
        }
    }, x = function(_, l, y) {
        ...
        var T = _.mediaType;
        if (T === "audio" || T === "video") {
            var E = t.getBitrateInfoListFor(T).find(function(I) {
    ...
    var v = function(_) {
        var l = _.request, y = _.mediaType;
        l = l || {}, o("requestcanceled", {
            request_event_type: l.type + "_" + l.action,
            request_url: l.url,
            request_type: y,
            request_hostname: F(l.url)
        });
    };
    t.on("fragmentLoadingAbandoned", v);
    var m = function(_) {
        var l = _.error, y, T, E = (l == null || (y = l.data) === null || y === void 0 ? void 0 : y.request) || {}, S = (l == null || (T = l.data) === null || T === void 0 ? void 0 : T.response) || {};
        (l == null ? void 0 : l.code) === 27 && o("requestfailed", {
        ...
        var I = "".concat(E != null && E.url ? "url: ".concat(E.url, "\n") : "") + "".concat(S != null && S.status || S != null && S.statusText ? "response: ".concat(S == null ? void 0 : S.status, ", ").concat(S == null ? void 0 : S.statusText, "\n") : "");
        o("error", {
            player_error_code: l == null ? void 0 : l.code,
            player_error_message: l == null ? void 0 : l.message,
            player_error_context: I
        });
    };
    t.on("error", m), t._stopMuxMonitor = function() {
        t.off("manifestLoaded", s), t.off("initFragmentLoaded", k), t.off("mediaFragmentLoaded", c), t.off("qualityChangeRendered", x), t.off("error", m), t.off("fragmentLoadingAbandoned", v), delete t._stopMuxMonitor;
    };
}, Ct = function(r) {
    r && typeof r._stopMuxMonitor == "function" && r._stopMuxMonitor();
};
var Mt = 0, pa = function() {
    "use strict";
    function r() {
        D(this, r), d(this, "_listeners", void 0);
    }
    return N(r, [
        {
            key: "on",
        ...
        },
        {
            ...
            value: function(t, i) {
                ...
                if (this._listeners) {
                    i = i || {};
                    var n = this._listeners["before" + t] || [], o = this._listeners["before*"] || [], s = this._listeners[t] || [], u = this._listeners["after" + t] || [], f = function(g, k) {
                        g = g.slice(), g.forEach(function(h) {
                            h.call(a, {
                                type: t
                            }, k);
                        });
...
var Be = G(Q()), ma = function() {
    "use strict";
    function r(e) {
        var t = this;
        D(this, r), d(this, "_playbackHeartbeatInterval", void 0), d(this, "_playheadShouldBeProgressing", void 0), d(this, "pm", void 0), this.pm = e, this._playbackHeartbeatInterval = null, this._playheadShouldBeProgressing = !1, e.on("playing", function() {
...
var va = function r(e) {
    "use strict";
    var t = this;
    D(this, r), d(this, "viewErrored", void 0), e.on("viewinit", function() {
        t.viewErrored = !1;
...
var ha = function() {
    "use strict";
    function r(e) {
        D(this, r), d(this, "_watchTimeTrackerLastCheckedTime", void 0), d(this, "pm", void 0), this.pm = e, this._watchTimeTrackerLastCheckedTime = null, e.on("playbackheartbeat", this._updateWatchTime.bind(this)), e.on("playbackheartbeatend", this._clearWatchTimeState.bind(this));
    }
    return N(r, [
        {
...
var ga = function() {
    "use strict";
    function r(e) {
        D(this, r), d(this, "pm", void 0), this.pm = e;
...
var Wt = 5 * 60 * 1e3, ba = function r(e) {
    "use strict";
...
var wa = function() {
    ...
    function r(e) {
        var t = this;
        D(this, r), d(this, "_lastCheckedTime", void 0), d(this, "_lastPlayheadTime", void 0), d(this, "_lastPlayheadTimeUpdatedTime", void 0), d(this, "_rebuffering", void 0), d(this, "pm", void 0), this.pm = e, !(e.disableRebufferTracking || e.disablePlayheadRebufferTracking) && (this._lastCheckedTime = null, this._lastPlayheadTime = null, this._lastPlayheadTimeUpdatedTime = null, e.on("playbackheartbeat", this._checkIfRebuffering.bind(this)), e.on("playbackheartbeatend", this._cleanupRebufferTracker.bind(this)), e.on("seeking", function() {
...
var Ta = function() {
    ...
    function r(e) {
        var t = this;
        D(this, r), d(this, "pm", void 0), this.pm = e, e.on("viewinit", function() {
...
var Ea = function r(e) {
    "use strict";
    var t = this;
    D(this, r), d(this, "_lastPlayerHeight", void 0), d(this, "_lastPlayerWidth", void 0), d(this, "_lastPlayheadPosition", void 0), d(this, "_lastSourceHeight", void 0), d(this, "_lastSourceWidth", void 0), e.on("viewinit", function() {
...
var ka = 2e3, xa = function r(e) {
    "use strict";
    var t = this;
    D(this, r), d(this, "isSeeking", void 0), this.isSeeking = !1;
    var i = -1, a = function() {
    ...
    e.on("seeking", function(n, o) {
        if (Object.assign(e.data, o), t.isSeeking && o.viewer_time - i <= ka) {
            i = o.viewer_time;
            return;
        }
...
var Yt = function(e, t) {
    ...
    function r(e) {
        var t = this;
        D(this, r), d(this, "_adHasPlayed", void 0), d(this, "_adRequests", void 0), d(this, "_adResponses", void 0), d(this, "_currentAdRequestNumber", void 0), d(this, "_currentAdResponseNumber", void 0), d(this, "_prerollPlayTime", void 0), d(this, "_wouldBeNewAdPlay", void 0), d(this, "isAdBreak", void 0), d(this, "pm", void 0), this.pm = e, e.on("viewinit", function() {
...
var qa = function r(e) {
    "use strict";
    var t = this;
    D(this, r), d(this, "lastWallClockTime", void 0);
    var i = function() {
        ...
        function i(a, n, o) {
            ...
            if (typeof document != "undefined") {
                ...
                for(var f = document.cookie ? document.cookie.split("; ") : [], g = /(%[0-9A-Z]{2})+/g, k = 0; k < f.length; k++){
                    var h = f[k].split("="), c = h.slice(1).join("=");
                    c.charAt(0) === '"' && (c = c.slice(1, -1));
                    try {
                        var p1 = h[0].replace(g, decodeURIComponent);
                        if (c = t.read ? t.read(c, p1) : t(c, p1) || c.replace(g, decodeURIComponent), this.json) try {
                            c = JSON.parse(c);
                        } catch (w) {}
                        if (a === p1) {
                            s = c;
...
function me(r) {
    ...
    return Object.keys(r).forEach(function(i) {
        ...
        if (r.hasOwnProperty(i) && r[i] !== void 0) {
            var n = i.split("_"), o = n[0], s = Oa[o];
            s || (R.info("Data key word `" + n[0] + "` not expected in " + i), s = o + "_"), n.splice(1).forEach(function(u) {
                u === "url" && (a = !0), ur[u] ? s += ur[u] : Number.isInteger(Number(u)) ? s += u : (R.info("Data key word `" + u + "` not expected in " + i), s += "_" + u + "_");
            }), a ? t[s] = r[i] : e[s] = r[i];
        }
    }), Object.assign(e, t);
}
...
var ni = {
    ...
    "requestfailed",
    "requestcanceled"
], ui = "https://img.litix.io", $ = function(e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this._beaconUrl = e || ui, this._eventQueue = [], this._postInFlight = !1, this._resendAfterPost = !1, this._failureCount = 0, this._sendTimeout = !1, this._options = Object.assign({}, ni, t);
};
...
$.prototype._sendBeaconQueue = function() {
    ...
    Cr(this._beaconUrl, t, !1, function(a, n) {
        n ? (r._eventQueue = e.concat(r._eventQueue), r._failureCount += 1, R.info("Error sending beacon: " + n)) : r._failureCount = 0, r._roundTripTime = A.now() - i, r._postInFlight = !1, r._resendAfterPost && (r._resendAfterPost = !1, r._eventQueue.length > 0 && r._sendBeaconQueue());
    });
};
...
$.prototype._createPayload = function(r) {
    ...
    return o(), s() || (R.info("Payload size is too big (" + n + " kb). Removing unnecessary events."), a = r.filter(function(u) {
        return si.indexOf(u.e) === -1;
    }), o()), s() || (R.info("Payload size still too big (" + n + " kb). Cropping fields.."), a.forEach(function(u) {
        for(var f in u){
            var g = u[f], k = 50 * 1024;
...
var li = [
    ...
    "ended",
    "viewend"
], pi = 10 * 60 * 1e3, Hr = function() {
    "use strict";
    function r(e, t) {
        var i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        D(this, r);
        var a, n, o, s, u, f, g, k, h, c, p1, w;
        d(this, "mux", void 0), d(this, "envKey", void 0), d(this, "options", void 0), d(this, "eventQueue", void 0), d(this, "sampleRate", void 0), d(this, "disableCookies", void 0), d(this, "respectDoNotTrack", void 0), d(this, "previousBeaconData", void 0), d(this, "lastEventTime", void 0), d(this, "rateLimited", void 0), d(this, "pageLevelData", void 0), d(this, "viewerData", void 0), this.mux = e, this.envKey = t, this.options = i, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.eventQueue = new Mr(Ke(this.envKey, this.options));
        var x;
        ...
        this.respectDoNotTrack = (m = this.options.respectDoNotTrack) !== null && m !== void 0 ? m : !1, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.pageLevelData = {
            ...
            viewer_os_family: (g = this.options.platform) === null || g === void 0 || (f = g.os) === null || f === void 0 ? void 0 : f.family,
            viewer_os_architecture: (h = this.options.platform) === null || h === void 0 || (k = h.os) === null || k === void 0 ? void 0 : k.architecture,
    ...
    return N(r, [
        {
            ...
            value: function(t, i) {
                if (!(!t || !(i != null && i.view_id))) {
                    if (this.respectDoNotTrack && ce()) return R.info("Not sending `" + t + "` because Do Not Track is enabled");
                    if (!i || typeof i != "object") return R.error("A data object was expected in send() but was not provided");
                    ...
                    if (this.lastEventTime = this.mux.utils.now(), s) return R.info("Not sending event due to sample rate restriction", t, n, f);
                    if (this.envKey || R.info("Missing environment key (envKey) - beacons will be dropped if the video source is not a valid mux video URL", t, n, f), !this.rateLimited) if (R.info("Sending event", t, n, f), this.rateLimited = !this.eventQueue.queueEvent(t, f), this.mux.WINDOW_UNLOADING && t === "viewend") this.eventQueue.destroy(!0);
                    else {
                        if (this.mux.WINDOW_HIDDEN && t === "hb") this.eventQueue.flushEvents(!0);
                        else if (fi.indexOf(t) >= 0) {
                            if (t === "error" && i.player_error_severity === "warning") return;
                            this.eventQueue.flushEvents();
                        }
                        if (this.rateLimited) return n.event = "eventrateexceeded", f = me(n), this.eventQueue.queueEvent(n.event, f), R.error("Beaconing disabled due to rate limit.");
                    }
                }
            }
        },
        ...
        },
        {
            ...
            value: function(t, i) {
                ...
                if (o === "-1" || t === "viewstart" || t === "viewend" || !this.previousBeaconData || this.mux.utils.now() - this.lastEventTime >= pi) n = ue({}, i), o && (this.previousBeaconData = n), o && t === "viewend" && (this.previousBeaconData = null);
                else {
                    var s = t.indexOf("request") === 0;
                    Object.entries(i).forEach(function(u) {
                        var f = H(u, 2), g = f[0], k = f[1];
                        a.previousBeaconData && (k !== a.previousBeaconData[g] || li.indexOf(g) > -1 || a.objectHasChanged(s, g, k, a.previousBeaconData[g]) || a.eventRequiresKey(t, g)) && (n[g] = k, a.previousBeaconData[g] = k);
                    });
                }
                return n;
            }
        ...
        },
        {
            ...
            value: function(t, i) {
                return !!(t === "renditionchange" && i.indexOf("video_source_") === 0 || _i.includes(i) && ci.includes(t));
            }
        }
    ]), r;
}();
var mi = function r(e) {
    "use strict";
    D(this, r);
    var t = 0, i = 0, a = 0, n = 0, o = 0, s = 0, u = 0, f = function(h, c) {
        ...
        if (w ? (m = w - (p1 != null ? p1 : 0), _ = (x != null ? x : 0) - w) : _ = (x != null ? x : 0) - (p1 != null ? p1 : 0), _ > 0 && v && v > 0) {
            var l = v / _ * 8e3;
            o++, i += v, a += _, e.data.view_min_request_throughput = Math.min(e.data.view_min_request_throughput || 1 / 0, l), e.data.view_average_request_throughput = i / a * 8e3, e.data.view_request_count = n, m > 0 && (t += m, e.data.view_max_request_latency = Math.max(e.data.view_max_request_latency || 0, m), e.data.view_average_request_latency = t / o);
        }
    }, g = function(h, c) {
...
var vi = 60 * 60 * 1e3, hi = function r(e) {
    "use strict";
    var t = this;
    D(this, r), d(this, "_lastEventTime", void 0), e.on("before*", function(i, a) {
        var n = a.viewer_time, o = A.now(), s = t._lastEventTime;
        if (t._lastEventTime = o, s && o - s > vi) {
            var u = Object.keys(e.data).reduce(function(g, k) {
                return k.indexOf("video_") === 0 ? Object.assign(g, d({}, k, e.data[k])) : g;
            }, {});
...
var wi = function(r) {
    ...
    "use strict";
    var t = this;
    D(this, r), d(this, "_emittingAutomaticEvent", !1), d(this, "_hasInitialized", !1), d(this, "_currentMode", "standard"), e.on("viewstart", function() {
        t._hasInitialized || (t._hasInitialized = !0, t._emittingAutomaticEvent = !0, e.emit("playbackmodechange", {
    ...
    function t(i, a, n) {
        ...
        var s = {
            ...
            emitTranslator: function() {
                for(var h = arguments.length, c = new Array(h), p1 = 0; p1 < h; p1++)c[p1] = arguments[p1];
                return c;
            },
        ...
        if (o.on("viewinit", function(h, c) {
            ...
            window.addEventListener("pagehide", g, !1), o.on("destroy", function() {
        ...
        o.on("playerready", function(h, c) {
            ...
            o.on(h, function(c, p1) {
                h.indexOf("ad") !== 0 && this._updateStateData(), Object.assign(this.data, p1), this._sanitizeData();
        ...
        return o.one("playerready", k), o.longResumeTracker = new Ur(b(o)), o.errorTracker = new Ut(b(o)), new $t(b(o)), o.seekingTracker = new Kt(b(o)), o.playheadTime = new jt(b(o)), o.playbackHeartbeat = new Bt(b(o)), new zt(b(o)), o.watchTimeTracker = new Ft(b(o)), new Vt(b(o)), o.adTracker = new Xt(b(o)), new Jt(b(o)), new Gt(b(o)), new Qt(b(o)), new Br(b(o)), new Vr(b(o)), new jr(b(o)), n.hlsjs && o.addHLSJS(n), n.dashjs && o.addDashJS(n), o.emit("viewinit", n.data), o;
    }
    return N(t, [
        {
            key: "emit",
        ...
        },
        {
            ...
            value: function(a) {
                if (this.data.view_id) {
                    ...
                    if (n.video_source_is_live === void 0 && (n.player_source_duration === 1 / 0 || n.video_source_duration === 1 / 0 ? n.video_source_is_live = !0 : (n.player_source_duration > 0 || n.video_source_duration > 0) && (n.video_source_is_live = !1)), n.video_source_is_live || o.forEach(function(g) {
                        n[g] = void 0;
...
function ot(r, e, t) {
    var i = H(se(e), 3), a = i[0], n = i[1], o = i[2], s = r.log, u = r.utils.getComputedStyle, f = r.utils.secondsToMs, g = {
    ...
    var k = {
        ...
        getStateData: function() {
            var p1, w, x, v = ((p1 = (w = this).getPlayheadTime) === null || p1 === void 0 ? void 0 : p1.call(w)) || f(a.currentTime), m = this.hlsjs && this.hlsjs.url, _ = this.dashjs && typeof this.dashjs.getSource == "function" && this.dashjs.getSource(), l = {
            ...
            if (a.getStartDate && v > 0) {
                ...
                if (y && typeof y.getTime == "function" && y.getTime()) {
                    var T = y.getTime();
                    if (l.player_program_time = T + v, a.seekable.length > 0) {
                        var E = T + a.seekable.end(a.seekable.length - 1);
                        l.player_live_edge_program_time = E;
                    }
                }
            }
            return l;
    ...
    t = Object.assign(g, t, k), t.data = Object.assign({
    ...
    a.mux.destroy = function() {
        ...
        }), delete a.mux.listeners, a.mux.fullscreenChangeListener && (document.removeEventListener("fullscreenchange", a.mux.fullscreenChangeListener, !1), delete a.mux.fullscreenChangeListener), a.mux.destroy = h, a.mux.swapElement = h, a.mux.emit = h, a.mux.addHLSJS = h, a.mux.addDashJS = h, a.mux.removeHLSJS = h, a.mux.removeDashJS = h, a.mux.updateData = h, a.mux.setEmitTranslator = h, a.mux.setStateDataTranslator = h, a.mux.setGetPlayheadTime = h, a.mux.deleted = !0, r.emit(n, "destroy");
        ...
        c === "error" && !t.automaticErrorTracking || (a.mux.listeners[c] = function() {
            ...
            if (c === "error") {
                ...
                p1.player_error_code = a.error.code, p1.player_error_message = Si[a.error.code] || a.error.message;
            }
            r.emit(n, c, p1);
...
Ve.prototype.processLine = function(r) {
    var e = r.indexOf(":"), t = Pi(r, e), i = t[0], a = t.length === 2 ? ct(t[1]) : void 0;
    if (i[0] !== "#") this.currentUri.uri = i, this.manifest.segments.push(this.currentUri), this.manifest.targetDuration && !("duration" in this.currentUri) && (this.currentUri.duration = this.manifest.targetDuration), this.currentUri = {};
        ...
        case le.PART_INF:
            {
                lt(this.manifest, t), this.manifest.partInf.partTarget && (this.manifest.partTargetDuration = this.manifest.partInf.partTarget), this.setHoldBack();
                break;
            }
        case le.SERVER_CONTROL:
            {
                lt(this.manifest, t), this.setHoldBack();
                break;
            }
        case le.INF:
            {
...
var lt = function(r, e) {
    var t = Gr(e[0].replace("#EXT-X-", "")), i;
    Ai(e[1]) ? (i = {}, i = Object.assign(Ri(e[1]), i)) : i = ct(e[1]), r[t] = i;
}, Gr = function(r) {
...
var Ni = "mux-embed", Ci = "5.15.0", Mi = "2.1", C = {}, ne = function(e) {
    var t = arguments;
    typeof e == "string" ? ne.hasOwnProperty(e) ? be.default.setTimeout(function() {
        t = Array.prototype.splice.call(t, 1), ne[e].apply(null, t);
    }, 0) : R.warn("`" + e + "` is an unknown task") : typeof e == "function" ? be.default.setTimeout(function() {
        e(ne);
    }, 0) : R.warn("`" + e + "` is invalid.");
}, Hi = {
    loaded: A.now(),
    NAME: Ni,
    VERSION: Ci,
    ...
    destroyMonitor: function(e) {
        ...
        i && i.mux && typeof i.mux.destroy == "function" ? i.mux.destroy() : R.error("A video element monitor for `" + e + "` has not been initialized via `mux.monitor`.");
    },
    addHLSJS: function(e, t) {
        var i = J(e);
        C[i] ? C[i].addHLSJS(t) : R.error("A monitor for `" + i + "` has not been initialized.");
    },
    addDashJS: function(e, t) {
        var i = J(e);
        C[i] ? C[i].addDashJS(t) : R.error("A monitor for `" + i + "` has not been initialized.");
    },
    removeHLSJS: function(e) {
        var t = J(e);
        C[t] ? C[t].removeHLSJS() : R.error("A monitor for `" + t + "` has not been initialized.");
    },
    removeDashJS: function(e) {
        var t = J(e);
        C[t] ? C[t].removeDashJS() : R.error("A monitor for `" + t + "` has not been initialized.");
    },
    init: function(e, t) {
        ce() && t && t.respectDoNotTrack && R.info("The browser's Do Not Track flag is enabled - Mux beaconing is disabled.");
        var i = J(e);
        C[i] = new Wr(ne, i, t);
    },
    emit: function(e, t, i) {
        var a = J(e);
        C[a] ? (C[a].emit(t, i), t === "destroy" && delete C[a]) : R.error("A monitor for `" + a + "` has not been initialized.");
    },
    updateData: function(e, t) {
        var i = J(e);
        C[i] ? C[i].emit("hb", t) : R.error("A monitor for `" + i + "` has not been initialized.");
    },
    setEmitTranslator: function(e, t) {
        var i = J(e);
        C[i] ? C[i].emitTranslator = t : R.error("A monitor for `" + i + "` has not been initialized.");
    },
    setStateDataTranslator: function(e, t) {
        var i = J(e);
        C[i] ? C[i].stateDataTranslator = t : R.error("A monitor for `" + i + "` has not been initialized.");
    },
    setGetPlayheadTime: function(e, t) {
        var i = J(e);
        C[i] ? C[i].getPlayheadTime = t : R.error("A monitor for `" + i + "` has not been initialized.");
    },
    checkDoNotTrack: ce,
    log: R,
    utils: Qr,
...
*/ }),
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+playback-core@0.32.2/node_modules/@mux/playback-core/dist/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$mux$2d$embed$40$5$2e$15$2e$0$2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/mux-embed@5.15.0/node_modules/mux-embed/dist/mux.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$hls$2e$js$40$1$2e$6$2e$15$2f$node_modules$2f$hls$2e$js$2f$dist$2f$hls$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/hls.js@1.6.15/node_modules/hls.js/dist/hls.mjs [app-client] (ecmascript)");
;
;
var E = __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$hls$2e$js$40$1$2e$6$2e$15$2f$node_modules$2f$hls$2e$js$2f$dist$2f$hls$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
var C = {
    VIDEO: "video",
    THUMBNAIL: "thumbnail",
...
`), n = (c = ((i = t.find((l)=>l.startsWith("#EXT-X-PLAYLIST-TYPE"))) != null ? i : "").split(":")[1]) == null ? void 0 : c.trim(), o = ee(n), s = te(n), a;
    ...
    if (typeof window != "undefined") return __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$mux$2d$embed$40$5$2e$15$2e$0$2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].utils.now();
}, It = __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$mux$2d$embed$40$5$2e$15$2e$0$2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].utils.generateUUID, qr = ({ playbackId: e, customDomain: t = S, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: s, programEndTime: a, assetStartTime: i, assetEndTime: c, playbackToken: d, tokens: { playback: l = d } = {}, extraSourceParams: u = {} } = {})=>{
    if (!e) return;
...
var Vt = (e, t)=>{
    ...
    var c;
    let { envKey: n, disableTracking: o, muxDataSDK: s = __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$mux$2d$embed$40$5$2e$15$2e$0$2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], muxDataSDKOptions: a = {} } = e, i = Ze(e);
    if (!o && (n || i)) {
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/custom-media-element@1.4.5/node_modules/custom-media-element/dist/custom-media-element.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+mux-video@0.29.2/node_modules/@mux/mux-video/dist/base.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+playback-core@0.32.2/node_modules/@mux/playback-core/dist/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$custom$2d$media$2d$element$40$1$2e$4$2e$5$2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/custom-media-element@1.4.5/node_modules/custom-media-element/dist/custom-media-element.js [app-client] (ecmascript)");
var C = (s)=>{
    throw TypeError(s);
};
...
var e = {
    ...
    TYPE: "type",
    LOGO: "logo"
}, at = Object.values(e), v = P(), x = "mux-video", E, m, _, g, p, O, R, I, M, c, A, T, K = class extends __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$custom$2d$media$2d$element$40$1$2e$4$2e$5$2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"] {
    constructor(){
        super();
        d(this, A);
        d(this, E);
        ...
        d(this, M);
        d(this, c, "");
        o(this, _, (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generatePlayerInitTime"])()), this.nativeEl.addEventListener("muxmetadata", (t)=>{
            var l;
            let i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getMetadata"])(this.nativeEl), r = (l = this.metadata) != null ? l : {};
            this.metadata = {
                ...i,
                ...r
    ...
    static get observedAttributes() {
        ...
        return [
            ...at,
            ...(t = __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$custom$2d$media$2d$element$40$1$2e$4$2e$5$2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"].observedAttributes) != null ? t : []
        ];
    }
    ...
    static getTemplateHTML(t = {}) {
        var i;
        return `
      ${__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$custom$2d$media$2d$element$40$1$2e$4$2e$5$2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"].getTemplateHTML(t)}
      <style>
        :host {
          position: relative;
        }
    ...
    set preferCmcd(t) {
        t !== this.preferCmcd && (t ? __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CmcdTypeValues"].includes(t) ? this.setAttribute(e.PREFER_CMCD, t) : console.warn(`Invalid value for preferCmcd. Must be one of ${__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CmcdTypeValues"].join()}`) : this.removeAttribute(e.PREFER_CMCD));
    }
    get playerInitTime() {
    ...
    get error() {
        var t;
        return (t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getError"])(this.nativeEl)) != null ? t : null;
    }
    get errorTranslator() {
        return n(this, M);
    }
    ...
    get playbackId() {
        var t;
        return this.hasAttribute(e.PLAYBACK_ID) ? this.getAttribute(e.PLAYBACK_ID) : (t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toPlaybackIdFromSrc"])(this.src)) != null ? t : void 0;
    }
    set playbackId(t) {
    ...
    get playbackToken() {
        ...
        if (this.hasAttribute(e.PLAYBACK_ID)) {
            let [, f] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toPlaybackIdParts"])((i = this.playbackId) != null ? i : "");
    ...
    get ended() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getEnded"])(this.nativeEl, this._hls);
    }
    get envKey() {
        var t;
    ...
    get streamType() {
        var t;
        return (t = this.getAttribute(e.STREAM_TYPE)) != null ? t : (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStreamType"])(this.nativeEl);
    }
    set streamType(t) {
        t !== this.streamType && (t ? this.setAttribute(e.STREAM_TYPE, t) : this.removeAttribute(e.STREAM_TYPE));
    }
    get targetLiveWindow() {
        return this.hasAttribute(e.TARGET_LIVE_WINDOW) ? +this.getAttribute(e.TARGET_LIVE_WINDOW) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getTargetLiveWindow"])(this.nativeEl);
    }
    ...
    get liveEdgeStart() {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getLiveEdgeStart"])(this.nativeEl);
    }
    get liveEdgeOffset() {
    ...
    get seekable() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getSeekable"])(this.nativeEl);
    }
    async addCuePoints(t) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addCuePoints"])(this.nativeEl, t);
    }
    get activeCuePoint() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getActiveCuePoint"])(this.nativeEl);
    }
    get cuePoints() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getCuePoints"])(this.nativeEl);
    }
    async addChapters(t) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addChapters"])(this.nativeEl, t);
    }
    get activeChapter() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getActiveChapter"])(this.nativeEl);
    }
    get chapters() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getChapters"])(this.nativeEl);
    }
    getStartDate() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStartDate"])(this.nativeEl, this._hls);
    }
    get currentPdt() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getCurrentPdt"])(this.nativeEl, this._hls);
    }
    get preferPlayback() {
        let t = this.getAttribute(e.PREFER_PLAYBACK);
        if (t === __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PlaybackTypes"].MSE || t === __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PlaybackTypes"].NATIVE) return t;
    }
    set preferPlayback(t) {
        t !== this.preferPlayback && (t === __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PlaybackTypes"].MSE || t === __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PlaybackTypes"].NATIVE ? this.setAttribute(e.PREFER_PLAYBACK, t) : this.removeAttribute(e.PREFER_PLAYBACK));
    }
    get metadata() {
        return {
    ...
    load() {
        o(this, E, (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initialize"])(this, this.nativeEl, n(this, E)));
    }
    unload() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["teardown"])(this.nativeEl, n(this, E), this), o(this, E, void 0);
    }
    attributeChangedCallback(t, i, r) {
        var f, L;
        switch(__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$custom$2d$media$2d$element$40$1$2e$4$2e$5$2f$node_modules$2f$custom$2d$media$2d$element$2f$dist$2f$custom$2d$media$2d$element$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomVideoElement"].observedAttributes.includes(t) && ![
            "src",
            "autoplay",
            "preload"
            ...
            case "preload":
                ...
                break;
            case e.PLAYBACK_ID:
                this.src = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toMuxVideoURL"])(this);
                break;
            case e.DEBUG:
                {
                    let u = this.debug;
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+mux-video@0.29.2/node_modules/@mux/mux-video/dist/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$mux$2d$video$40$0$2e$29$2e$2$2f$node_modules$2f40$mux$2f$mux$2d$video$2f$dist$2f$base$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+mux-video@0.29.2/node_modules/@mux/mux-video/dist/base.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$mixin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/castable-video@1.1.11/node_modules/castable-video/castable-mixin.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/index.js [app-client] (ecmascript) <locals>");
...
;
;
var r, i = class extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$mixin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CastableMediaMixin"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$mixin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MediaTracksMixin"])(__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$mux$2d$video$40$0$2e$29$2e$2$2f$node_modules$2f40$mux$2f$mux$2d$video$2f$dist$2f$base$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["MuxVideoBaseElement"])) {
    constructor(){
        super(...arguments);
        m(this, r);
    }
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/castable-video@1.1.11/node_modules/castable-video/castable-utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/castable-video@1.1.11/node_modules/castable-video/castable-remote-playback.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/castable-video@1.1.11/node_modules/castable-video/castable-utils.js [app-client] (ecmascript)");
;
const remoteInstances = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IterableWeakSet"]();
const castElementRef = new WeakSet();
let cf;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onCastApiAvailable"])(()=>{
    if (!globalThis.chrome?.cast?.isAvailable) {
    ...
    if (!cf) {
        cf = cast.framework;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["castContext"])().addEventListener(cf.CastContextEventType.CAST_STATE_CHANGED, (e)=>{
            remoteInstances.forEach((r)=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["privateProps"].get(r).onCastStateChanged?.(e));
        });
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["castContext"])().addEventListener(cf.CastContextEventType.SESSION_STATE_CHANGED, (e)=>{
            remoteInstances.forEach((r)=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["privateProps"].get(r).onSessionStateChanged?.(e));
        });
        remoteInstances.forEach((r)=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["privateProps"].get(r).init?.());
    }
});
...
class RemotePlayback extends EventTarget {
    ...
    constructor(media){
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["privateProps"].set(this, {
            init: ()=>this.#init(),
   ...
   */ get state() {
    ...
    async watchAvailability(callback) {
        if (this.#media.disableRemotePlayback) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InvalidStateError"]('disableRemotePlayback attribute is present.');
        }
    ...
    async prompt() {
        ...
        if (!globalThis.chrome?.cast?.isAvailable) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotSupportedError"]('The RemotePlayback API is disabled on this platform.');
        }
        const willDisconnect = castElementRef.has(this.#media);
        castElementRef.add(this.#media);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCastOptions"])(this.#media.castOptions);
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["castContext"])().requestSession();
        } catch (err) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["privateProps"].get(this.#media)?.loadOnPrompt?.();
    }
    #disconnect() {
    ...
    #hasDevicesAvailable() {
        ...
        const castState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["castContext"])()?.getCastState();
    ...
    async #onSessionStateChanged() {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["castContext"])().getSessionState() === SESSION_RESUMED) {
            /**
       ...
       */ if (this.#media.castSrc === (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["currentMedia"])()?.media.contentId) {
                castElementRef.add(this.#media);
                Object.entries(this.#remoteListeners).forEach(([event, listener])=>{
                    this.#remotePlayer.controller.addEventListener(event, listener);
                });
         ...
         */ try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMediaStatus"])(new chrome.cast.media.GetStatusRequest());
                } catch (error) {
                    console.error(error);
                }
    ...
    async #updateRemoteTextTrack() {
        ...
        const activeTrackIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["currentSession"])()?.getSessionObj().media[0]?.activeTrackIds ?? [];
        ...
        if (!arrayEquals(activeTrackIds, requestTrackIds)) {
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editTracksInfo"])(request);
            } catch (error) {
                console.error(error);
            }
        }
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/castable-video@1.1.11/node_modules/castable-video/castable-mixin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$remote$2d$playback$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/castable-video@1.1.11/node_modules/castable-video/castable-remote-playback.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/castable-video@1.1.11/node_modules/castable-video/castable-utils.js [app-client] (ecmascript)");
;
;
const CastableMediaMixin = (superclass)=>class CastableMedia extends superclass {
        ...
        #castOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultCastOptions"])();
        #castCustomData;
        #remote;
        get remote() {
            if (this.#remote) return this.#remote;
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requiresCastFramework"])()) {
                // No need to load the Cast framework if it's disabled.
                if (!this.disableRemotePlayback) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadCastFramework"])();
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["privateProps"].set(this, {
                    loadOnPrompt: ()=>this.#loadOnPrompt()
                });
                return this.#remote = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$remote$2d$playback$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RemotePlayback"](this);
            }
            return super.remote;
        }
        get #castPlayer() {
            return __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["privateProps"].get(this.remote)?.getCastPlayer?.();
        }
        attributeChangedCallback(attrName, oldValue, newValue) {
        ...
        async load() {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isHls"])(this.castSrc)) {
                const segmentFormat = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPlaylistSegmentFormat"])(this.castSrc);
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$castable$2d$video$40$1$2e$1$2e$11$2f$node_modules$2f$castable$2d$video$2f$castable$2d$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["currentSession"])()?.loadMedia(request);
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/change-event.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/video-track-list.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function addVideoTrack(media, track) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media = media;
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).renditionSet) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).renditionSet = /* @__PURE__ */ new Set();
    }
    const trackSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).trackSet;
    trackSet.add(track);
    ...
    if (!(index in VideoTrackList.prototype)) {
        Object.defineProperty(VideoTrackList.prototype, index, {
            get () {
                return [
                    ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(this).trackSet
                ][index];
            }
        });
    }
    queueMicrotask(()=>{
        trackList.dispatchEvent(new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$change$2d$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TrackEvent"]("addtrack", {
            track
        }));
    });
}
function removeVideoTrack(track) {
    const trackList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media?.videoTracks;
    if (!trackList) return;
    const trackSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).trackSet;
    trackSet.delete(track);
    queueMicrotask(()=>{
        trackList.dispatchEvent(new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$change$2d$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TrackEvent"]("removetrack", {
            track
        }));
    });
}
function selectedChanged(selected) {
    const trackList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(selected).media.videoTracks ?? [];
    ...
    if (hasUnselected) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).changeRequested) return;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).changeRequested = true;
        queueMicrotask(()=>{
            delete (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).changeRequested;
...
class VideoTrackList extends EventTarget {
    ...
    constructor(){
        super();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(this).trackSet = /* @__PURE__ */ new Set();
    }
    get #tracks() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(this).trackSet;
    }
    [Symbol.iterator]() {
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/rendition-event.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/video-rendition-list.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function addRendition(track, rendition) {
    const renditionList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media.videoRenditions;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).media = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).track = track;
    const renditionSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).renditionSet;
    ...
    queueMicrotask(()=>{
        ...
        renditionList.dispatchEvent(new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$rendition$2d$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenditionEvent"]("addrendition", {
            rendition
        }));
    });
}
function removeRendition(rendition) {
    const renditionList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).media.videoRenditions;
    const track = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).track;
    const renditionSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).renditionSet;
    renditionSet.delete(rendition);
    queueMicrotask(()=>{
        const track2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).track;
        if (!track2.selected) return;
        renditionList.dispatchEvent(new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$rendition$2d$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenditionEvent"]("removerendition", {
            rendition
        }));
    });
}
function selectedChanged(rendition) {
    const renditionList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).media.videoRenditions;
    if (!renditionList || (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(renditionList).changeRequested) return;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(renditionList).changeRequested = true;
    queueMicrotask(()=>{
        delete (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(renditionList).changeRequested;
        const track = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).track;
        if (!track.selected) return;
...
function getCurrentRenditions(renditionList) {
    const media = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(renditionList).media;
    return [
        ...media.videoTracks
    ].filter((track)=>track.selected).flatMap((track)=>[
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).renditionSet
        ]);
}
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/video-rendition.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class VideoRendition {
    ...
    set selected(val) {
        ...
        this.#selected = val;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectedChanged"])(this);
    }
}
;
}),
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/video-track.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class VideoTrack {
    ...
    addRendition(src, width, height, codec, bitrate, frameRate) {
        const rendition = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$rendition$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoRendition"]();
        rendition.src = src;
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addRendition"])(this, rendition);
        return rendition;
    }
    removeRendition(rendition) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeRendition"])(rendition);
    }
    get selected() {
        return this.#selected;
    }
    set selected(val) {
        ...
        this.#selected = val;
        if (val !== true) return;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectedChanged"])(this);
    }
}
;
}),
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/audio-rendition-list.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function addRendition(track, rendition) {
    const renditionList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media.audioRenditions;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).media = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).track = track;
    const renditionSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).renditionSet;
    renditionSet.add(rendition);
...
function removeRendition(rendition) {
    const renditionList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).media.audioRenditions;
    const track = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(rendition).track;
    const renditionSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).renditionSet;
    renditionSet.delete(rendition);
    queueMicrotask(()=>{
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/audio-rendition.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AudioRendition {
    ...
    set selected(val) {
        if (this.#selected === val) return;
        this.#selected = val;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectedChanged"])(this);
    }
}
;
}),
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/audio-track-list.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function removeAudioTrack(track) {
    const trackList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media?.audioTracks;
    if (!trackList) return;
    const trackSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).trackSet;
    trackSet.delete(track);
    queueMicrotask(()=>{
...
function enabledChanged(track) {
    const trackList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(track).media.audioTracks;
    if (!trackList || (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).changeRequested) return;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).changeRequested = true;
    queueMicrotask(()=>{
        delete (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(trackList).changeRequested;
        trackList.dispatchEvent(new Event("change"));
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/audio-track.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AudioTrack {
    ...
    addRendition(src, codec, bitrate) {
        const rendition = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$rendition$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioRendition"]();
        rendition.src = src;
        rendition.codec = codec;
        rendition.bitrate = bitrate;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addRendition"])(this, rendition);
        return rendition;
    }
    removeRendition(rendition) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeRendition"])(rendition);
    }
    get enabled() {
        return this.#enabled;
    }
    set enabled(val) {
        ...
        this.#enabled = val;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enabledChanged"])(this);
    }
}
;
}),
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/mixin.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MediaTracksMixin(MediaElementClass) {
    ...
    if (!("addVideoTrack" in MediaElementClass.prototype)) {
        MediaElementClass.prototype.addVideoTrack = function(kind, label = "", language = "") {
            const track = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoTrack"]();
            track.kind = kind;
            track.label = label;
            track.language = language;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addVideoTrack"])(this, track);
            return track;
        };
    }
    if (!("removeVideoTrack" in MediaElementClass.prototype)) {
        MediaElementClass.prototype.removeVideoTrack = __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeVideoTrack"];
    }
    if (!("addAudioTrack" in MediaElementClass.prototype)) {
        MediaElementClass.prototype.addAudioTrack = function(kind, label = "", language = "") {
            const track = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioTrack"]();
            track.kind = kind;
            track.label = label;
            track.language = language;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAudioTrack"])(this, track);
            return track;
        };
    }
    if (!("removeAudioTrack" in MediaElementClass.prototype)) {
        MediaElementClass.prototype.removeAudioTrack = __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeAudioTrack"];
    }
    ...
    const initVideoRenditions = (media)=>{
        let renditions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).videoRenditions;
        if (!renditions) {
            renditions = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoRenditionList"]();
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(renditions).media = media;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).videoRenditions = renditions;
        }
        return renditions;
    };
    ...
    const initAudioRenditions = (media)=>{
        let renditions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).audioRenditions;
        if (!renditions) {
            renditions = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$rendition$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioRenditionList"]();
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(renditions).media = media;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).audioRenditions = renditions;
        }
        return renditions;
    };
...
function getVideoTracks(media) {
    let tracks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).videoTracks;
    if (!tracks) {
        tracks = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoTrackList"]();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).videoTracks = tracks;
        if (nativeVideoTracksFn) {
            ...
            for (const nativeTrack of nativeTracks){
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addVideoTrack"])(media, nativeTrack);
            }
            ...
            nativeTracks.addEventListener("addtrack", (event)=>{
                if ([
                    ...tracks
                ].some((t)=>t instanceof __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoTrack"])) {
                    for (const nativeTrack of nativeTracks){
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeVideoTrack"])(nativeTrack);
                    }
                    return;
                }
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addVideoTrack"])(media, event.track);
            });
            nativeTracks.addEventListener("removetrack", (event)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$video$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeVideoTrack"])(event.track);
            });
        }
    }
    return tracks;
...
function getAudioTracks(media) {
    let tracks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).audioTracks;
    if (!tracks) {
        tracks = new __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioTrackList"]();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPrivate"])(media).audioTracks = tracks;
        if (nativeAudioTracksFn) {
            const nativeTracks = nativeAudioTracksFn.call(media.nativeEl ?? media);
            for (const nativeTrack of nativeTracks){
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAudioTrack"])(media, nativeTrack);
            }
            nativeTracks.addEventListener("change", ()=>{
                tracks.dispatchEvent(new Event("change"));
            });
            nativeTracks.addEventListener("addtrack", (event)=>{
                if ([
                    ...tracks
                ].some((t)=>t instanceof __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioTrack"])) {
                    for (const nativeTrack of nativeTracks){
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeAudioTrack"])(nativeTrack);
                    }
                    return;
                }
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addAudioTrack"])(media, event.track);
            });
            nativeTracks.addEventListener("removetrack", (event)=>{
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$media$2d$tracks$40$0$2e$3$2e$4$2f$node_modules$2f$media$2d$tracks$2f$dist$2f$audio$2d$track$2d$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeAudioTrack"])(event.track);
            });
        }
    }
    return tracks;
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/media-tracks@0.3.4/node_modules/media-tracks/dist/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+mux-player-react@3.10.2_@types+react-dom@19.2.2_@types+react@19.2.2__@types+react@_d28a7f46cafc1a5a79c6b58272d81e3f/node_modules/@mux/mux-player-react/dist/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+playback-core@0.32.2/node_modules/@mux/playback-core/dist/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$mux$2d$player$40$3$2e$10$2e$2_react$40$19$2e$2$2e$0$2f$node_modules$2f40$mux$2f$mux$2d$player$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+mux-player@3.10.2_react@19.2.0/node_modules/@mux/mux-player/dist/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$mux$2d$player$40$3$2e$10$2e$2_react$40$19$2e$2$2e$0$2f$node_modules$2f40$mux$2f$mux$2d$player$2f$dist$2f$base$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+mux-player@3.10.2_react@19.2.0/node_modules/@mux/mux-player/dist/base.mjs [app-client] (ecmascript)");
"use client";
;
;
;
;
var M = parseInt(__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version) >= 19, E = {
    className: "class",
    classname: "class",
    htmlFor: "for",
...
var oe = Object.prototype.hasOwnProperty, ue = (e, t)=>{
    ...
    e[n] = t;
}, ie = (e, t, n, o = se, a = p)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
;
var r = (e, t, n)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
var Pe = __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].forwardRef(({ children: e, ...t }, n)=>__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("mux-player", {
    ...
    var i;
    let n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), o = f(n, t), [a] = xe(n, e), [l] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])((i = e.playerInitTime) != null ? i : (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$playback$2d$core$40$0$2e$32$2e$2$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generatePlayerInitTime"])());
...
"[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/sanity@5.2.0_@emotion+is-prop-valid@1.4.0_@portabletext+sanity-bridge@2.0.0_@types+reac_1fa5c8f85a09d43fbd968d38b7e8f92d/node_modules/sanity/lib/_chunks-es/VideoPlayer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$mux$2d$player$2d$react$40$3$2e$10$2e$2_$40$types$2b$react$2d$dom$40$19$2e$2$2e$2_$40$types$2b$react$40$19$2e$2$2e$2_$5f40$types$2b$react$40$_d28a7f46cafc1a5a79c6b58272d81e3f$2f$node_modules$2f40$mux$2f$mux$2d$player$2d$react$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/code/cedesigns/theresa_kennish/node_modules/.pnpm/@mux+mux-player-react@3.10.2_@types+react-dom@19.2.2_@types+react@19.2.2__@types+react@_d28a7f46cafc1a5a79c6b58272d81e3f/node_modules/@mux/mux-player-react/dist/index.mjs [app-client] (ecmascript) <locals>");
;
;
;
function VideoPlayer(t0) {
    ...
    let t2;
    return $[1] !== customDomain || $[2] !== playbackId || $[3] !== tokens ? (t2 = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_$40$babel$2b$core$40$7$2e$28$2e$5_babel$2d$plugin$2d$react$2d$compiler$40$1$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$code$2f$cedesigns$2f$theresa_kennish$2f$node_modules$2f2e$pnpm$2f40$mux$2b$mux$2d$player$2d$react$40$3$2e$10$2e$2_$40$types$2b$react$2d$dom$40$19$2e$2$2e$2_$40$types$2b$react$40$19$2e$2$2e$2_$5f40$types$2b$react$40$_d28a7f46cafc1a5a79c6b58272d81e3f$2f$node_modules$2f40$mux$2f$mux$2d$player$2d$react$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
        customDomain,
        theme: "sutro",
        playbackId,
        tokens,
...
//# sourceMappingURL=bd9be__pnpm_9a7dd874._.js.map